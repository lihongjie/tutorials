...
public class Test extends JFrame {
   public static void main(String args[]) {
      SwingApp.launch(new Test(), "A Sort Decorator.example.Decorator",
                                   300, 300, 450, 250);
   }
   public Test() {
      ...
      // reference is Decorator.example.TableSortDecorator even though it
      // actually points to a Decorator.example.TableBubbleSortDecorator--that
      // way, the mouse listener below will work with any type
      // of Decorator.example.TableSortDecorator.
