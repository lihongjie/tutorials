...
/**
 *  ChainOfResponsibility.example1.Bridge.src.example.State.example.TemplateMethod.example.Strategy.example.Test for our Singleton registry
 */
public class TestB  {
    public static void main(String[] args) {
        // First we get a instance from Singleton.example.SingletonB
